...
export default function PlaylistCard({ playlist }: PlaylistCardProps) {
    return (
        ...
        >
            <div className="relative bg-[#1a1f27] border border-white/5 rounded-xl p-4 cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-black/40">
                {/* Cover area */}
                <div className="relative overflow-hidden rounded-lg">
                    <div
                        className={`aspect-square rounded-lg bg-gradient-to-br ${playlist.coverColor} transition-all duration-300 group-hover:brightness-110`}
                    />
